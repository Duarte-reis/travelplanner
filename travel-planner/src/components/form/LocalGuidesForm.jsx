...
function LocalGuidesForm({formIndex, updateLocalGuidesFormData, serviceNameContainer = [], price1Container = [], price2Container = [], price3Container = [], price4Container = [], price5Container = [], price6Container = [], price7Container = [], checkButtonContainer = []}) {
